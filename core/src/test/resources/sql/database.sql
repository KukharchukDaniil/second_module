...
values('certificate_one', 'b_description', 1, 1, NULL, NULL);
INSERT INTO gift_certificate(name, description, price, duration, create_date,last_update_date)
values('certificate_two', 'a_description', 1, 1, NULL, NULL);
INSERT INTO gift_certificate(name, description, price, duration, create_date,last_update_date)
values('certificate_three', 'c_description', 1, 1, NULL, NULL);
...
INSERT INTO certificate_tag(tag_id, certificate_id) VALUES(1,2);
INSERT INTO certificate_tag(tag_id, certificate_id) VALUES(2,3);
INSERT INTO certificate_tag(tag_id, certificate_id) VALUES(2,1);